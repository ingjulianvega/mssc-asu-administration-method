...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {AdministrationMethodException.class})
    protected ResponseEntity<Object> handleConflict(AdministrationMethodException ex, WebRequest request) {
